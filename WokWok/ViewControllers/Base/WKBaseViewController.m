...
#define kCustomNavigationBarHeight 44
...
- (void)makeBaseProperties
{
    ...
    self.customNavigationBarHeight = CGRectGetHeight([UIApplication sharedApplication].statusBarFrame) + kCustomNavigationBarHeight;
    self.contentWidth = CGRectGetWidth([UIScreen mainScreen].bounds);
    self.contentHeight = CGRectGetHeight([UIScreen mainScreen].bounds) - self.customNavigationBarHeight;
...
{
    CGRect barFrame = CGRectMake(0, 0, self.contentWidth, self.customNavigationBarHeight);
